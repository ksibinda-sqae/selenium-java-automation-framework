...
**Local:** After running tests, Allure results and report are generated in `reports/` folder:
```bash
# Run tests
mvn test

# View report (if allure CLI installed)
allure serve reports/allure-results

# Or manually generate and open
allure generate reports/allure-results -o reports/allure-report --clean
allure open reports/allure-report
```

**Files generated:**
- `reports/allure-results/` — Raw test results (generated by tests)
- `reports/allure-report/` — HTML report (generated by Allure CLI)
